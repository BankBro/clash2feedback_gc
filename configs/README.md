...
本目录存放各阶段配置文件. 当前已实现 `phase0.yaml`, `phase1_clash_detector.yaml`, `phase2_injection.yaml`, `phase2_5_model_induced_audit.yaml`, `phase3_label_provenance_audit.yaml` 和 `phase4_0_backend_feasibility.yaml`.
