...
- `repair/`: 阶段 4.0 backend feasibility 审计, 包括 S2 preflight/formal case selection, phase2/base sample 输入合成, 规则型固定拓扑局部修复, DiffSBDD/DiffDec wrapper, topology-changing candidate verifier adapter 和报告汇总.
